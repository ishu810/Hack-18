  ...
  return (
    <div className="bg-[#243b3e] border border-[rgba(201,168,76,0.15)] rounded-lg p-5 mb-6 text-[#f0ede6]">
      ...
      <div className="space-y-4">
        <div>
<<<<<<< HEAD
          <label className="text-[10px] text-[#9db5b2] uppercase tracking-widest">Origin - Destination</label>
          <div className="font-mono text-sm mt-1">{trip.origin} → {trip.destination}</div>
        </div>
        <div>
          <label className="text-[10px] text-[#9db5b2] uppercase tracking-widest">Timeline</label>
          <div className="font-mono text-sm mt-1">{dates.departure} — {dates.return}</div>
        </div>
        <div>
          <label className="text-[10px] text-[#9db5b2] uppercase tracking-widest">Allocated Budget</label>
          <div className="font-mono text-sm text-[#4ecdc4] mt-1">${budget.toLocaleString()} USD</div>
        </div>
        <button className="w-full mt-4 bg-linear-to-r from-[#c9a84c] to-[#a88a38] text-[#1c2b2d] font-bold py-2 rounded text-xs uppercase tracking-widest shadow-[0_0_10px_rgba(201,168,76,0.3)] hover:opacity-90">
=======
